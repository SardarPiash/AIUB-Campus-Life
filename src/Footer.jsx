    ...
    <div>
      <footer className="bg-blue-800 text-white py-6">
        <div className="container mx-auto grid md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className='text-left ml-9'>
              ...
              <li><Link to="#" className="hover:underline">Faculty of Business Administration</Link></li>
              <li><Link to="#" className="hover:underline">Faculty of Engineering</Link></li>
              <li><Link to="#" className="hover:underline">Faculty of Science & Technology</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className='text-left ml-24'>
              ...
              <li><Link to="#" className="hover:underline">Visitors</Link></li>
              <li><Link to="#" className="hover:underline">Future Students</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="container mx-auto  flex items-center justify-between space-x-4">
          <div className="flex">
            <img src="../src/assets/Aiub_logo.png" className="h-12 w-12" alt="AIUB Logo"/>
