...
export default function Facilities() {
  return (
    <div className="bg-gray-100">
        <main className="container mx-auto p-8 border border-black border-opacity-15 rounded-md">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      {FacilitiesData.map((data)=>(
        ...
        <div className="p-4">
          ...
          <Link to={`/facilities/${slugify(data.name)}` } className="mt-4 inline-block px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-300"><button>Read more</button></Link>
          </div>
      </div>
      ))}
    </div>
